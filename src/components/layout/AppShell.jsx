  ...
  return (
    <div className="min-h-full flex bg-ivory-2">
      ...
      <div className="flex-1 flex justify-center md:justify-start min-w-0">
        <div className="w-full max-w-[480px] md:max-w-[720px] lg:max-w-[820px] h-[100dvh] flex flex-col bg-ivory md:bg-transparent md:py-6 md:pl-8 md:pr-6 shadow-[0_0_60px_rgba(0,0,0,0.04)] md:shadow-none">
